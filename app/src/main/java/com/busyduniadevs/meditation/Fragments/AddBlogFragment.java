...
public class AddBlogFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        DocumentReference userDocument = db.collection("user").document(currentUserId);
        userDocument.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    dp = documentSnapshot.getString("image");
                }
            }
        });
    ...
    private void uploadData(final String titl, final String description) {
        ...
        storageReference1.putBytes(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                firebaseAuth = FirebaseAuth.getInstance();
                String currentUserId2 = firebaseAuth.getCurrentUser().getUid();
                ...
                if (uriTask.isSuccessful()) {
                    ...
                    hashMap.put("uid", currentUserId2);
